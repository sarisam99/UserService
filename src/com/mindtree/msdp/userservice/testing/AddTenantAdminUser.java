...
public class AddTenantAdminUser {
	...
	public static void main(String[] args) throws InvalidKeyException, HttpException, NoSuchAlgorithmException, IOException {
		...
		//Add tenant admin user is also same as adding new user ...change email id or tenant Name to get 200 response
		...
		data.setEmail("sariputraAdmin@gmail.com");
		...
		userService.addTenantAdminUser(data);
